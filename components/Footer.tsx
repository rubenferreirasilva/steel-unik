        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                <Clock size={16} className="text-steel-accent flex-shrink-0" />
                <span className="text-steel-muted text-sm">
                  Seg–Sex: 8h30–17h30
                </span>
              </div>
            ...
            <ul className="flex flex-col gap-3">
              {services.map((service) => (
                <li key={service.label}>
                  <Link
                    href={service.href}
                    className="text-steel-muted hover:text-steel-accent transition-colors text-sm flex items-center gap-2 group"
                  >
                    <ArrowRight
                      size={12}
          ...
          <div>
            ...
            <div className="mt-4 p-4 bg-steel-card border border-steel-border rounded-sm">
              <p className="text-steel-accent text-xs font-semibold uppercase tracking-wider mb-1">
                Resposta Garantida
              </p>
              <p className="text-steel-muted text-xs">✓ Menos de 24 horas úteis</p>
              <p className="text-steel-muted text-xs">✓ Protótipo digital incluído</p>
              <p className="text-steel-muted text-xs">✓ Sem compromisso inicial</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <Link href="/politica-privacidade" className="text-steel-muted hover:text-white text-xs transition-colors">
                Política de Privacidade
              </Link>
              <Link href="/termos" className="text-steel-muted hover:text-white text-xs transition-colors">
                Termos de Uso
              </Link>
              <div className="flex items-center gap-2">
                <Link href="/" className="text-steel-accent hover:text-steel-accent-light text-xs font-semibold transition-colors">PT</Link>
                <span className="text-steel-border">|</span>
                <Link href="/es" className="text-steel-muted hover:text-white text-xs transition-colors">ES</Link>
              </div>
            </div>
          </div>
        </div>
